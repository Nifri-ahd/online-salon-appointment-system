...
include('CusSession.php'); // Includes Login Script
if(isset($_SESSION['login_user'])){
header("location: SESSIONindex.php"); // Redirecting To Profile home Page
}
?>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ml-lg-auto">
                    ...
                    <li class="nav-item">
                        <a href="Csignup.php" class="nav-link smoothScroll">Create Account</i></a>
...
<form class="box2" name="login"  method="POST" onsubmit="return (validateData());">
  ...
  <u><a href="Cforget.php" name="passReset" >Forgot Password</a></u>
<br>
  <input type="submit" name="btnSubmit" value="Login">
	...
	.
		<a href="Csignup.php">Create Account</a>
