...
<head>
  ...
  <title>Assistant Reset Password</title>
  <!-- plugins:css -->
    ...
    <div class="main-wrapper">
      <div class="page-wrapper full-page-wrapper d-flex align-items-center justify-content-center">
        <main class="auth-page">
          <center><p class="w3-xxlarge">ASSISTANT RESET PASSWORD</p></center> <br> <br>
                    ...
                    <div class="mdc-layout-grid">
                      ...
                      <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                            <input class="mdc-text-field__input" type="text" id="text-field-hero-input" name="txtusername">
                            <div class="mdc-line-ripple"></div>
                            <label for="text-field-hero-input" class="mdc-floating-label">Enter Username</label>
                          </div>
                        </div>
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                        ...
                        <div class="mdc-layout-grid__cell stretch-card mdc-layout-grid__cell--span-12">
                          <div class="mdc-text-field w-100">
                            ...
                            <div class="mdc-line-ripple"></div>
                            <label for="text-field-hero-input" class="mdc-floating-label">Re-Enter New Pasword</label>
                          </div>
                        </div>
                        ...
                        <span style="color:blue; size:15;"><center><u><a href= "ASSlogin.php">LOGIN</a></u></center> </span>
                      </div>
                    </div>
                  </form>
                     <?php
                        ...
                        $user_update_query = "UPDATE `assistant` SET `assi_password`='$forgot_password' WHERE `assi_username`='$username'";
